  ...
  return {
    create: async (
      ...
      let defaultEventTypes: SupportedTestEventTypes[] = [
        ...
        { title: "Paid", slug: "paid", 
          // leadId: "", 
          eventType: "", businessUnit: "", calendarName: "", length: 30, price: 1000 },
        { title: "Opt in", slug: "opt-in", 
          // leadId: "", 
          eventType: "", 
          businessUnit: "", calendarName: "", requiresConfirmation: true, length: 30 },
        { title: "Seated", slug: "seated", 
          // leadId: "", 
          eventType: "", 
          businessUnit: "", calendarName: "", seatsPerTimeSlot: 2, length: 30 },
      ];
